...
public class ClusterSummary implements org.apache.thrift.TBase<ClusterSummary, ClusterSummary._Fields>, java.io.Serializable, Cloneable {
  ...
  public void validate() throws TException {
    ...
    if (supervisors == null) {
      throw new TProtocolException("Required field 'supervisors' was not present! Struct: " + toString());
    }
    // alas, we cannot check 'nimbus_uptime_secs' because it's a primitive and you chose the non-beans generator.
    if (topologies == null) {
      throw new TProtocolException("Required field 'topologies' was not present! Struct: " + toString());
    }
  ...
  private static class ClusterSummaryStandardScheme extends StandardScheme<ClusterSummary> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, ClusterSummary struct) throws TException {
      ...
      if (!struct.isSetNimbus_uptime_secs()) {
        throw new TProtocolException("Required field 'nimbus_uptime_secs' was not found in serialized data! Struct: " + toString());
      }
      struct.validate();
    }
