  ...
  private static class TopologySummaryStandardScheme extends StandardScheme<TopologySummary> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, TopologySummary struct) throws TException {
      ...
      if (!struct.isSetNum_tasks()) {
        throw new TProtocolException("Required field 'num_tasks' was not found in serialized data! Struct: " + toString());
      }
      if (!struct.isSetNum_executors()) {
        throw new TProtocolException("Required field 'num_executors' was not found in serialized data! Struct: " + toString());
      }
      if (!struct.isSetNum_workers()) {
        throw new TProtocolException("Required field 'num_workers' was not found in serialized data! Struct: " + toString());
      }
