...
public class StreamInfo implements org.apache.thrift.TBase<StreamInfo, StreamInfo._Fields>, java.io.Serializable, Cloneable {
  ...
  public void validate() throws TException {
    ...
    if (output_fields == null) {
      throw new TProtocolException("Required field 'output_fields' was not present! Struct: " + toString());
    }
  ...
  private static class StreamInfoStandardScheme extends StandardScheme<StreamInfo> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, StreamInfo struct) throws TException {
      ...
      if (!struct.isSetDirect()) {
        throw new TProtocolException("Required field 'direct' was not found in serialized data! Struct: " + toString());
      }
      struct.validate();
    }
