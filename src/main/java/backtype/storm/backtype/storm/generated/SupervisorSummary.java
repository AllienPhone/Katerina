...
public class SupervisorSummary implements org.apache.thrift.TBase<SupervisorSummary, SupervisorSummary._Fields>, java.io.Serializable, Cloneable {
  ...
  public void validate() throws TException {
    ...
    if (supervisor_id == null) {
      throw new TProtocolException("Required field 'supervisor_id' was not present! Struct: " + toString());
    }
  ...
  private static class SupervisorSummaryStandardScheme extends StandardScheme<SupervisorSummary> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, SupervisorSummary struct) throws TException {
      ...
      if (!struct.isSetNum_used_workers()) {
        throw new TProtocolException("Required field 'num_used_workers' was not found in serialized data! Struct: " + toString());
      }
      struct.validate();
    }
