...
public class ComponentCommon implements org.apache.thrift.TBase<ComponentCommon, ComponentCommon._Fields>, java.io.Serializable, Cloneable {
  ...
  public void validate() throws TException {
    ...
    if (inputs == null) {
      throw new TProtocolException("Required field 'inputs' was not present! Struct: " + toString());
    }
    if (streams == null) {
      throw new TProtocolException("Required field 'streams' was not present! Struct: " + toString());
    }
