...
public class GlobalStreamId implements org.apache.thrift.TBase<GlobalStreamId, GlobalStreamId._Fields>, java.io.Serializable, Cloneable {
  ...
  public void validate() throws TException {
    ...
    if (componentId == null) {
      throw new TProtocolException("Required field 'componentId' was not present! Struct: " + toString());
    }
    if (streamId == null) {
      throw new TProtocolException("Required field 'streamId' was not present! Struct: " + toString());
    }
