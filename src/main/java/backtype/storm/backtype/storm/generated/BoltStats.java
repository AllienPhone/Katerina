...
public class BoltStats implements org.apache.thrift.TBase<BoltStats, BoltStats._Fields>, java.io.Serializable, Cloneable {
  ...
  public void validate() throws TException {
    ...
    if (acked == null) {
      throw new TProtocolException("Required field 'acked' was not present! Struct: " + toString());
    }
    if (failed == null) {
      throw new TProtocolException("Required field 'failed' was not present! Struct: " + toString());
    }
    if (process_ms_avg == null) {
      throw new TProtocolException("Required field 'process_ms_avg' was not present! Struct: " + toString());
    }
    if (executed == null) {
      throw new TProtocolException("Required field 'executed' was not present! Struct: " + toString());
    }
    if (execute_ms_avg == null) {
      throw new TProtocolException("Required field 'execute_ms_avg' was not present! Struct: " + toString());
    }
  ...
  private static class BoltStatsStandardScheme extends StandardScheme<BoltStats> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, BoltStats struct) throws TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, BoltStats struct) throws TException {
      struct.validate();
  ...
  private static class BoltStatsTupleScheme extends TupleScheme<BoltStats> {
    ...
    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, BoltStats struct) throws TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, BoltStats struct) throws TException {
